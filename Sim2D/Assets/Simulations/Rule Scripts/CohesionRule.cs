...
[CreateAssetMenu(menuName = "Group/Rule/Cohesion")]
public class CohesionRule : FilterGroupRule
{
    /// <summary>
    /// Calculates an offset average position of an actor's neighbours.
    /// </summary>
    ...
    public override Vector2 CalculateMove(GroupActor actor, List<Transform> neighbours, Group group)
    {
        ...
        // Offset average position using actor's current position
